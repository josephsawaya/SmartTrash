...
void setup(){
  ...
  scale.set_scale(600);//Calibrates scale (See calibration instructions)
...
void loop(){
    ...
    String inches = String(inch);
    Particle.publish("isItFull",inches);
    delay(500);
  ...
  String boyohboy = String(scaleValue);
    Particle.publish("Weight",boyohboy );
  //Get new Readings
  if(updatePrev){
